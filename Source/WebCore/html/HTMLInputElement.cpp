...
static Ref<StyleGradientImage> autoFillStrongPasswordMaskImage()
{
    Vector<StyleGradientImage::Stop> stops {
        { StyleColor(Color::black), CSSValuePool::singleton().createValue(50, CSSUnitType::CSS_PERCENTAGE) },
        { StyleColor(Color::transparentBlack), CSSValuePool::singleton().createValue(100, CSSUnitType::CSS_PERCENTAGE) }
    };
