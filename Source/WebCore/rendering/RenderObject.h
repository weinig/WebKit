...
class RenderObject : public CachedImageClient, public StyleImageClient, public CanMakeCheckedPtr<RenderObject> {
...
public:
    ...
    // Types inheriting from RenderObject can override this method to be notified
    // about image changes.
